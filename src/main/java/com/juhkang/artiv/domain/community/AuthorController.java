...
public class AuthorController {
    ...
    @GetMapping("/{authorId}/series")
    public List<SeriesSummaryResponse> authorSeries(@PathVariable Long authorId) {
        return seriesService.getAuthorSeries(authorId);
    }
}
