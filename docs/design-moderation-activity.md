...
| **3. 인앱 알림 저장소** | V20 notifications(폴리모픽·title/message·read_at·dedup_key) + Notification 엔티티/enum + NotificationService(fanOut 멱등·getMine·unreadCount·markRead/All) + NotificationController(폴링 API) | ⬜ 다음 |
